 ...
 * &allowedValues list (comma separated) optional.  Default: false
 * &allowedTypes string optional. (naturalNumbers 1,2,3,4,) 
 * &default string optional. Default: '' Return if request is not set or empty.
 * &fallbackvalue string optional. Default: '' Return if request value validation fails
 *
 *
 * USAGE:
 *
